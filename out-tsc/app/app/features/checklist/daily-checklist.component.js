...
export class DailyChecklistComponent {
    ...
    static { this.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: DailyChecklistComponent, selectors: [["app-daily-checklist"]], viewQuery: function DailyChecklistComponent_Query(rf, ctx) { if (rf & 1) {
            ...
            i0.ɵɵadvance(3);
            i0.ɵɵproperty("disabled", !ctx.hasOlderDate());
            i0.ɵɵadvance(6);
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(DailyChecklistComponent, { className: "DailyChecklistComponent", filePath: "src/app/features/checklist/daily-checklist.component.ts", lineNumber: 740 }); })();
