import { buildAccreditationMethodTagId, buildTagKey, compareChemicalMethodCodes, deriveMethodSeries, normalizeNafi6ChemicalMethodCode, } from './standard-tag.utils';
...
export const VLAT_11669_CHEMICAL_METHOD_CODES = SORTED_METHOD_CODES;
export const VLAT_11669_CHEMICAL_METHOD_TAGS = SORTED_METHOD_CODES.map((rawCode, index) => {
...
export const VLAT_11669_CHEMICAL_METHOD_KEYS = VLAT_11669_CHEMICAL_METHOD_TAGS.map(item => buildTagKey('CUSTOM', item.id));
export const VLAT_11669_CHEMICAL_METHOD_DEVICE_MAP = new Map(VLAT_11669_CHEMICAL_METHOD_TAGS.map(item => [item.methodCode, item.deviceCodes || []]));
export function getVlatMethodSeries(methodCode) {
    return deriveMethodSeries(methodCode);
}
//# sourceMappingURL=vlat-1-1669-487-20251015-chemical-method-tags.js.map