export function parseGs1Data(code) {
    const result = { isGs1: false, raw: code };
    if (!code) {
    ...
    if (code.startsWith('http://') || code.startsWith('https://')) {
        try {
            ...
            if (ai01Index !== -1 && ai01Index + 1 < pathParts.length) {
                ...
                if (url.searchParams.has('10'))
                    result.lotNumber = url.searchParams.get('10') || undefined;
 ...
 */
export function generateHybridGs1Code(item) {
...
//# sourceMappingURL=gs1-parser.js.map