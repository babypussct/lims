...
export function isSopActivityAction(action) {
...
export function matchesDashboardActivityCategory(action, category) {
    if (category === 'ALL')
        return true;
    if (category === 'APPROVE') {
 ...
 */
export function filterDashboardActivityLogs(logs, searchTerm, category, getActionText, maxItems = 50) {
