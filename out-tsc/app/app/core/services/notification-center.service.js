...
export class NotificationCenterService {
    constructor() {
        ...
        this.inbox = inject(NotificationService);
        ...
        effect(() => {
            ...
            if (incoming.eventId && this.wasSeen(incoming.eventId))
                return;
    ...
    static { this.ɵfac = function NotificationCenterService_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || NotificationCenterService)(); }; }
    static { this.ɵprov = /*@__PURE__*/ i0.ɵɵdefineInjectable({ token: NotificationCenterService, factory: NotificationCenterService.ɵfac, providedIn: 'root' }); }
}
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(NotificationCenterService, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], () => [], null); })();
//# sourceMappingURL=notification-center.service.js.map