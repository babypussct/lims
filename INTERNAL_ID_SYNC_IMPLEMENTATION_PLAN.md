...
| **10** | Kích thước Chunking & Nested Logs Volume | **Mặc định an toàn ban đầu là 249 thay đổi/batch; tinh chỉnh theo dry-run thực tế** | 249 thay đổi/batch giữ đúng cam kết “nhỏ hơn 250” và vẫn nằm dưới giới hạn 500 writes của Firestore Batch, kể cả 1 audit write bổ sung. Các trường của cùng một tài liệu không bị tách giữa hai batch. Kích thước chunk cuối cùng có thể được chốt lại sau khi đo lường số lượng nested usage logs và write amplification thực tế qua dry-run trên production. |
