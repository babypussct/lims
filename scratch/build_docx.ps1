# PowerShell script to prepare directories, call node cleanup, and build docx

$ErrorActionPreference = "Stop"

$workspace = "C:\Users\GCMS\Documents\GitHub\lims"
$srcExtracted = Join-Path $workspace "filebieumau_extracted"
$destExtracted = Join-Path $workspace "filebieumau_FORM_CLEAN_extracted"
$destDocx = Join-Path $workspace "filebieumau_FORM_CLEAN.docx"
$nodeExe = "C:\Users\GCMS\AppData\Local\ms-playwright-go\1.57.0\node.exe"
$cleanupScript = Join-Path $workspace "scratch\clean_document.js"
...
$tempZip = Join-Path $workspace "filebieumau_FORM_CLEAN.zip"
