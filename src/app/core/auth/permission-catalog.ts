export const PERMISSIONS = {
  ...
  STANDARD_AUDIT_VIEW: 'standard_audit_view',
...
export const PERMISSION_CATALOG: readonly PermissionDefinition[] = [
  ...
  { code: PERMISSIONS.STANDARD_AUDIT_VIEW, label: 'Xem chất chuẩn - Audit', description: 'Chỉ xem 10 trường thông tin được phê duyệt cho kiểm tra Audit; không có thao tác nghiệp vụ.', group: 'standards', risk: 'normal' },
