...
import { collection, getDocs, writeBatch, doc, serverTimestamp, deleteField, query, where } from 'firebase/firestore';
...
service cloud.firestore {
  ...
  async restoreRecycleItem(item: any) {
      ...
      try {
          ...
          // Legacy force refresh UI signal
  ...
  async emptyRecycleBin() {
      ...
      try {
          ...
          // Phát tín hiệu F5 cho toàn bộ hệ thống
