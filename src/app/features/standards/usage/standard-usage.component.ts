    ...
    <div class="flex flex-col space-y-4 fade-in h-full relative p-1 pb-6 custom-scrollbar overflow-y-auto overflow-x-hidden">
      ...
      <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 shrink-0 px-2 mt-2">
        ...
        <div class="flex gap-3 items-center">
             <button (click)="stdService.fixHistoricalUsageLogsUsers()" *ngIf="auth.isAdmin()" class="px-4 py-2.5 bg-rose-500 text-white hover:bg-rose-600 rounded-2xl shadow-xl shadow-rose-200 dark:shadow-none transition-all font-bold text-xs flex items-center gap-2">
