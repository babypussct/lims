...
export class Sop1767856825928EntryComponent extends AbstractSopEntry implements OnChanges {

  // ── UI State đặc thù: tab + search query ─────────────────────────────────
  ...
  protected override onSopSpecificInit() {
    // SOP 1767856825928 (Nhóm Cúc) dùng 6 điểm chuẩn (C0–C5)
    this.initCalibrationPoints(6);
