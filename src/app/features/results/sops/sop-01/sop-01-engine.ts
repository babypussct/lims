...
/**
 * Tính toán độ thu hồi của mẫu thêm chuẩn (spike recovery) cho 7 hoạt chất của Fipronil/Chlorpyrifos ở nồng độ thêm chuẩn 5 ppb.
 * @param row Bản ghi dữ liệu của dòng mẫu thử
 * @param sampleCode Mã số mẫu thử hoặc key dòng mẫu
 * @returns Chuỗi hiển thị kết quả độ thu hồi (ví dụ: "Fip: 98%, FipDesl: 101%...")
 */
