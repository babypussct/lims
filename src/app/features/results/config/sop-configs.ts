...
export const ANGULAR_SOP_CONFIG: Record<string, {
  ...
  'chlor-huu-co': {
    ...
    signaturePlaceholders: { 'date1': 'ngayNguoiPhanTich', 'date2': 'ngayNguoiThamTra' },
    compounds: [
      'Aldrin', 'BHC-alpha (benzene hexachloride)', 'BHC-beta', 'BHC-delta', 'BHC-epsilon', 'BHC-gamma (Lindane, gamma HCH)',
      'Chlordane-cis (alpha)', 'Chlordane-oxy', 'Chlordane-trans (gamma)',
      "DDD-o,p'", "DDD-p,p'", "DDE-o,p'", "DDE-p,p'", "DDT-o,p'", "DDT-p,p'",
      'Dieldrin', 'Endosulfan I (alpha isomer)', 'Endosulfan II (beta isomer)', 'Endosulfan sulfate', 'Endrin',
      'Heptachlor', 'Heptachlor endo-epoxide (isomer A)', 'Heptachlor exo-epoxide (isomer B)',
      'Hexachlorobenzene', 'Isodrin', "Methoxychlor, p,p'-", 'Mirex', 'Pendimethalin'
    ]
  },
  'lan-huu-co': {
    formType: 'type3b',
